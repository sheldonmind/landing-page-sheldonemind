...
const chatProviders = [
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" fill="white" width="22" height="22">
        <path d="M13.827 3.52h3.603L24 20h-3.603l-6.57-16.48zm-7.258 0h3.767L16.906 20h-3.674l-1.343-3.461H5.017L3.674 20H0L6.569 3.52zm4.132 9.959-1.977-5.24-1.977 5.24h3.954z" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" fill="white" width="22" height="22">
        <path d="M21.4 10.28c-.13-.49-.5-.82-.93-.97a2.43 2.43 0 0 0-.79-.12c-.68 0-1.48.22-2.4.62-1.16.5-2.2.76-3.09.76-.62 0-1.14-.11-1.57-.32A7.26 7.26 0 0 0 12 10c-2.21 0-4.17.85-5.61 2.24A7.83 7.83 0 0 0 4.07 18c0 2.36.88 4.31 2.32 5.69A7.68 7.68 0 0 0 12 26c2.21 0 4.17-.85 5.61-2.24A7.83 7.83 0 0 0 19.93 18c0-.63-.07-.25-.04-.58a1.4 1.4 0 0 0-.19-.5c-.16-.26-.42-.44-.72-.53a1.72 1.72 0 0 0-.49-.07c-.66 0-1.37.38-1.91.91a4.26 4.26 0 0 1-3.09 1.29 4.27 4.27 0 0 1-3.1-1.3A4.36 4.36 0 0 1 9.11 15c0-1.21.49-2.31 1.28-3.11a4.27 4.27 0 0 1 3.1-1.3c.89 0 1.71.28 2.38.76.25.17.47.37.67.59.36.4.61.88.73 1.4.07.34.09.6.03.78-.04.14-.13.25-.26.32-.16.09-.37.13-.63.13-.39 0-.84-.1-1.27-.26a4.96 4.96 0 0 0-1.77-.33 4.96 4.96 0 0 0-1.77.33c-1.07.4-1.83 1.3-2 2.33a3 3 0 0 0-.04.51c0 1.67 1.35 3.03 3.02 3.03a3.01 3.01 0 0 0 3.01-3.03v-.03c.01-.17.1-.32.24-.4.09-.06.21-.08.32-.07.22.03.39.2.42.43.02.18.02.43-.02.74-.07.47-.22.91-.46 1.3a4.17 4.17 0 0 1-1.08 1.2 4.13 4.13 0 0 1-2.43.78A4.14 4.14 0 0 1 9.8 18a4.14 4.14 0 0 1 4.14-4.15c.54 0 1.06.1 1.53.29.41.16.79.39 1.11.67a2.9 2.9 0 0 1 .89 2.11 2.9 2.9 0 0 1-.89 2.11 2.89 2.89 0 0 1-2.06.86 2.89 2.89 0 0 1-2.89-2.9c0-.25.03-.5.09-.73a2.8 2.8 0 0 1 1.91-1.94c.3-.08.61-.13.93-.13.49 0 .96.1 1.38.29l.33.17c.42.25.74.62.92 1.07.11.26.16.55.16.84 0 1.28-1.03 2.32-2.3 2.32a2.29 2.29 0 0 1-1.64-.68A2.3 2.3 0 0 1 12 16.95a2.3 2.3 0 0 1 2.3-2.31 2.3 2.3 0 0 1 2.3 2.31.58.58 0 1 0 1.15 0 3.45 3.45 0 0 0-3.45-3.46 3.45 3.45 0 0 0-3.45 3.46 3.45 3.45 0 0 0 3.45 3.46 3.45 3.45 0 0 0 3.45-3.46" />
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" fill="white" width="22" height="22">
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 2.2a7.8 7.8 0 1 1 0 15.6A7.8 7.8 0 0 1 12 4.2zm0 2a5.8 5.8 0 1 0 0 11.6A5.8 5.8 0 0 0 12 6.2zm0 2a3.8 3.8 0 1 1 0 7.6A3.8 3.8 0 0 1 12 8.2zm0 2a1.8 1.8 0 1 0 0 3.6A1.8 1.8 0 0 0 12 10.2z" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" fill="white" width="22" height="22">
        <rect x="2.5" y="7" width="3" height="10" rx="1.5" />
        <rect x="7.5" y="3" width="3" height="14" rx="1.5" />
        <rect x="12.5" y="7" width="3" height="10" rx="1.5" />
...
const mediaProviders = [
  {
    ...
    svg: (
      <svg viewBox="0 0 36 36" width="24" height="24">
        <text y="26" fontSize="22" textAnchor="middle" x="18">
          🍌
        </text>
      </svg>
    ),
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" fill="white" width="22" height="22">
        <path d="M12 2 8.5 9.5H1.5l6 4.5-2.3 7L12 17l6.8 4-2.3-7 6-4.5h-7z" />
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" fill="white" width="22" height="22">
        ...
        <circle cx="6.4" cy="6.4" r="1.2" />
        <circle cx="17.6" cy="17.6" r="1.2" />
        <circle cx="6.4" cy="17.6" r="1.2" />
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" fill="white" width="22" height="22">
        ...
        <rect x="3" y="10.75" width="13" height="2.5" rx="1.25" />
        <rect x="3" y="16" width="8" height="2.5" rx="1.25" />
      </svg>
    ),
  },
];
...
function getProviderForModel(name: string): (typeof allProviders)[number] {
  ...
  if (n.startsWith("gpt-") || n.startsWith("dall-e"))
  ...
  if (n.includes("pika") || n.startsWith("fal-ai/pika"))
    return providerByKey["FA"];
...
const galleryFeatures = [
  [
    "Explore Gallery",
    "Discover the most beautiful AI-generated images from the community. Get inspired, save favorites, and reuse prompts instantly.",
  ],
  [
    "Blueprints & Presets",
    "Ready-made presets for fast, consistent creation. Apply any blueprint to jump-start your next generation.",
  ],
  [
    "One-Click Recreate",
    ...
    <section id="pricing">
      <div className="text-center">
        ...
        <p className="mt-2 text-sm text-slate-400">
          Top up credits when you need them. No subscription required — or
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-3">
        ...
        <article className="rounded-2xl border border-slate-800 bg-slate-950/60 p-5">
          ...
          <p className="mt-2 text-xs text-slate-400">
            {freePlan.freeCreditsPerMonth} free credits/mo ·{" "}
            {freePlan.extraCreditPrice} {freePlan.extraCreditUnit}
          </p>
          <a
        ...
        <article className="rounded-2xl border border-slate-600 bg-slate-900/90 p-5">
          ...
          <p className="mt-2 text-xs text-slate-400">
            {proPlan.freeCreditsPerMonth} + {proPlan.monthlyCreditPackage}{" "}
            credits/mo · {proPlan.extraCreditPrice} {proPlan.extraCreditUnit}
          </p>
          <a
            href="https://app.sheldonmind.com/"
        ...
        <article className="rounded-2xl border border-slate-800 bg-slate-950/60 p-5">
          ...
          <p className="mt-2 text-xs text-slate-400">
            {businessPlan.freeCreditsPerMonth} +{" "}
            {businessPlan.monthlyCreditPackage} credits/mo ·{" "}
            {businessPlan.extraCreditPrice} {businessPlan.extraCreditUnit}
          </p>
          <a
            href="https://app.sheldonmind.com/"
      ...
      <p className="mt-6 text-center text-sm text-slate-400">
        No subscription needed to start. Top up credits from $1 to $1,000 and
        use any model, any feature — pay only for what you use.
      </p>
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#0a0a0a] font-sans text-slate-100">
      ...
      <header className="sticky top-0 z-30 w-full border-b border-slate-800/70 bg-[#0a0a0a]/90 backdrop-blur-xl">
        <nav className="mx-auto flex max-w-6xl items-center px-4 py-3.5 lg:px-6">
          ...
          <div className="hidden items-center gap-6 rounded-full border border-slate-700/70 bg-slate-900/50 px-5 py-1.5 text-xs text-slate-300 md:flex">
            {["Features", "Gallery", "Pricing", "FAQ", "Contact"].map(
              (item) => (
                <a
                  key={item}
                  href={
      ...
      <main className="w-full overflow-x-hidden">
        ...
        <section className="relative min-h-[85vh] w-full overflow-hidden text-center">
          <video
          ...
          <div className="relative z-10 flex min-h-[85vh] flex-col items-center justify-center px-4 pt-16 pb-12 sm:pt-20">
            ...
            <p className="mx-auto mt-4 max-w-xl text-sm text-slate-300">
              Multi‑AI chat, image & video generation with the most powerful
              models. Pay as you go — no subscription required.
            </p>
            <div className="mt-6" />
            <div className="mt-7 flex justify-center gap-4 text-slate-500">
              <span>𝕏</span>
              <span>◎</span>
              <span>◌</span>
            </div>
        ...
        <div className="mx-auto w-full max-w-6xl overflow-x-hidden px-4 pb-24 lg:px-6">
          ...
          <section id="feature-details">
            <div className="text-left sm:text-center">
              ...
              <h2 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl lg:text-5xl">
                Chat · Image · Video{" "}
                <span className="font-display italic">in the app</span>
              </h2>
              <p className="mt-2 text-sm text-slate-400">
                Choose model per conversation, token-by-token streaming, credit
                deduction by model and token
              </p>
            </div>
            <div className="mt-8 grid min-w-0 gap-4 md:grid-cols-2 lg:grid-cols-3">
              <article className="min-w-0 rounded-2xl border border-slate-800 bg-slate-950/60 p-4">
                ...
                <p className="mt-2 text-sm text-slate-300">
                  Chat with multiple AI models in one place — switch between
                  GPT-4o, Claude, Gemini, DeepSeek & more for every
                  conversation.
                </p>
              </article>
              <article className="min-w-0 rounded-2xl border border-slate-800 bg-slate-950/60 p-4 md:col-span-1 lg:col-span-2">
                ...
                <p className="mt-2 text-sm text-slate-300">
                  Generate stunning images with all the most powerful models —
                  DALL·E 3, Midjourney, Stable Diffusion, Flux & more. Choose
              ...
              <article className="min-w-0 rounded-2xl border border-slate-800 bg-slate-950/60 p-4 md:col-span-1 lg:col-span-2">
                ...
                <p className="mt-2 text-sm text-slate-300">
                  Generate video from text, image, or video. Powered by the
                  newest models — Kling, Veo, Sora & more as they release.
                </p>
              </article>
              <article className="min-w-0 rounded-2xl border border-slate-800 bg-slate-950/60 p-4">
                <h3 className="text-lg font-semibold">Pay As You Go</h3>
                <p className="mt-2 text-sm text-slate-300">
                  No subscription required. Add credits when you need them and
                  use any model or feature.
                </p>
                <ul className="mt-4 space-y-2 text-sm text-slate-300">
          ...
          <section id="features">
            <div className="text-center">
              ...
              <h2 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl lg:text-5xl">
                Powered by the{" "}
                <span className="font-display italic">best models</span>
              </h2>
              <p className="mt-2 text-sm text-slate-400">
                Access the latest AI models for chat, image & video — all in one
                platform
              </p>
            </div>
            ...
            <div className="relative flex min-w-0 flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
              <div className="relative z-20 min-w-0 flex-1 rounded-2xl bg-slate-950/10 p-5 backdrop-blur-2xl sm:p-6 lg:p-7">
                ...
                <p className="mt-4 max-w-lg text-base text-slate-300/90">
                  Create authentic images and videos with natural texture and
                  easy style. One platform, all the best AI models.
                </p>
                <a
                  href="#features"
              ...
              <div className="relative z-10 -ml-10 flex min-w-0 flex-1 gap-5 overflow-x-auto pb-2 lg:-ml-24 lg:justify-start">
                {[
                  [
                    "Create Image",
                    "Text-to-image with DALL·E, Flux, Midjourney & more",
                  ],
                  ["Create Video", "T2V, I2V, V2V with Kling, Veo, Sora"],
                  ["AI Chat", "GPT-4o, Claude, Gemini — all in one place"],
                  [
                    "Explore Gallery",
                    "Discover & remix beautiful community creations",
                  ],
                ].map(([title]) => (
                  <a
                    key={title}
                              ...
                              <div className="relative h-full w-full">
                                ...
                                <div className="absolute inset-x-4 bottom-4 space-y-1.5 text-[10px] leading-snug">
                                  <div className="ml-auto max-w-[80%] rounded-xl bg-sky-500/90 px-2 py-1 text-right text-slate-950 shadow-sm">
                                    Generate ideas &amp; prompts for my next
                                    project.
                                  </div>
                                  <div className="max-w-[82%] rounded-xl bg-slate-800/90 px-2 py-1 text-slate-100 shadow-sm">
                                    Sure. I&apos;ll suggest chat, image, and
                                    video prompts you can remix.
                                  </div>
                                </div>
                              </div>
                            </div>
                        ...
                        <div className="absolute inset-0 flex items-center justify-center p-1">
                          ...
                          <div className="relative h-full w-[90%]">
                            <div
                              ...
                              style={{
                                transform:
                                  "rotate(-10deg) translateX(-6px) translateY(2px)",
                              }}
                            >
                              <video
                                loop
                            ...
                            <span className="absolute -right-0.5 -top-0.5 z-20 flex h-5 w-5 items-center justify-center rounded-full bg-slate-700/90 text-xs font-medium text-blue-400 shadow-sm transition group-hover:bg-slate-600/90">
                              +
                            </span>
                          </div>
                        </div>
          ...
          <section id="gallery">
            <div className="text-center">
              ...
              <h2 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl lg:text-5xl">
                Explore stunning{" "}
                <span className="font-display italic">AI art</span>
              </h2>
              <p className="mt-2 text-sm text-slate-400">
                Browse beautiful community images, remix with one click, and
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-3">
              ...
              <div className="rounded-2xl border border-slate-800 bg-slate-950/60 p-3 md:p-3 text-xs md:text-sm md:col-span-2 md:row-start-2">
                ...
                <p className="mt-1 text-[11px] text-slate-300 md:text-xs">
                  File library for images, videos, and general files. Upload,
                  delete, filter by type and source.
                </p>
          ...
          <section id="faq">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-slate-400">
                Credit, plans, sign-in, and content management
              </p>
            </div>
            <div className="mx-auto mt-8 grid max-w-4xl gap-4 md:grid-cols-[0.8fr_1.2fr]">
              <aside className="rounded-2xl border border-slate-800 bg-slate-950/60 p-5">
                ...
                <a
                  href="#contact"
                  className="mt-4 inline-block rounded-md border border-slate-700 bg-slate-900/60 px-4 py-2 text-sm"
                >
                  ↗ Contact
                </a>
              </aside>
              <div className="space-y-2">
                {[
                  ...
                  [
                    ...
                    "We support the latest and most powerful models — GPT-4o, Claude 4, Gemini 2.5, DALL·E 3, Midjourney, Flux, Kling, Veo, Sora & more. New models added as they launch.",
                  ],
                  [
                  ...
                  [
                    ...
                    "Chat deducts by model and token count. Image and video deduct per generation based on model, resolution, and duration. Full history available in Billing.",
                  ],
                ].map(([q, a], idx) => (
                  <details
                    key={q}
          ...
          <section id="contact" className="text-center">
            ...
            <h2 className="mx-auto mt-4 max-w-2xl text-3xl font-semibold tracking-tight sm:text-4xl lg:text-5xl">
              ...
              <span className="font-display italic">
                Sign in to SheldonMind
              </span>
            </h2>
            <p className="mt-3 text-sm text-slate-300">
              Sign in with Google to use Chat, Image, Video, and manage your
              credits
            </p>
            <a
              href="https://app.sheldonmind.com/"
      ...
      <footer className="border-t border-slate-800/70 py-7">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-4 text-xs text-slate-500 md:flex-row lg:px-6">
          <a href="#" className="flex items-center gap-2">
            ...
            <span className="font-display text-xl italic text-slate-300">
              SheldonMind
            </span>
          </a>
