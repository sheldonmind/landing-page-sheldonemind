  ...
  return (
    <div className="min-h-screen bg-background text-slate-100">
      ...
      <main className="mx-auto max-w-3xl px-6 py-12 text-slate-300">
        <h1 className="font-display text-4xl font-semibold text-slate-100">Privacy Policy</h1>
        ...
        <div className="mt-10">
          ...
          <Section title="2. Information We Collect">
            ...
            <strong className="mt-3 block text-slate-200">Usage Data</strong>
            <ul className="mt-1 list-disc space-y-1 pl-5">
            ...
            <strong className="mt-3 block text-slate-200">Billing & Financial Data</strong>
            <ul className="mt-1 list-disc space-y-1 pl-5">
            ...
            <strong className="mt-3 block text-slate-200">Integration Credentials</strong>
            <ul className="mt-1 list-disc space-y-1 pl-5">
          ...
          <Section title="4. Data Sharing">
            ...
            <ul className="mt-2 list-disc space-y-1 pl-5">
              <li>
                <strong className="text-slate-200">AI Providers</strong> — your prompts are transmitted
              ...
              <li>
                <strong className="text-slate-200">Cloud Infrastructure</strong> — files you upload are
                stored on AWS S3. We use Redis for session caching and PostgreSQL for persistent data.
              </li>
              <li>
                <strong className="text-slate-200">Payment Processor</strong> — billing is handled by
                Lemon Squeezy; we share only what is necessary to complete transactions.
              </li>
              <li>
                <strong className="text-slate-200">Legal Obligations</strong> — we may disclose data if
                required by law or to protect the rights and safety of users.
              </li>
            </ul>
            We do <strong className="text-slate-200">not</strong> sell your personal data to third parties.
          </Section>
